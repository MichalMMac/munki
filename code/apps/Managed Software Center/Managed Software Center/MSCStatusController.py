...
##### required status methods #####
    ...
    def doRestartAlert(self):
        ...
        alert = NSAlert.alertWithMessageText_defaultButton_alternateButton_otherButton_informativeTextWithFormat_(
            NSLocalizedString(
                u"Restart Required", u"Restart Required title"), NSLocalizedString(
                u"Restart", u"Restart button title"), nil, nil, u"%@", NSLocalizedString(
...
def more_localized_strings():
    ...
    foo = NSLocalizedString(
        u"Performing preflight tasks...",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Performing postflight tasks...",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Checking for available updates...",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Checking for additional changes...",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Software installed or removed requires a restart.",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Waiting for network...",
        "managedsoftwareupdate message")
    ...
    foo = NSLocalizedString(u"Determining which filesystem items to remove",
                            "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Removing receipt info",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Nothing to remove.",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Package removal complete.",
        "managedsoftwareupdate message")
    ...
    foo = NSLocalizedString(
        u"Running Adobe Setup",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Running Adobe Uninstall",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Starting Adobe installer...",
        "managedsoftwareupdate message")
    foo = NSLocalizedString(
        u"Running Adobe Patch Installer",
        "managedsoftwareupdate message")
