...
class MSCBadgedTemplateImage(NSImage):
    ...
    def imageNamed_withCount_(self, name, count):
        ...
        # draw base image
        baseImageOrigin = NSMakePoint(
            badgeOutlineHeight / 2,
            badgeOutlineHeight / 2)
        ...
        # draw count string
        badgeString.drawWithRect_options_attributes_(
            badgeStringRect, 0, stringAttributes)
